        ...
        case "Multi-Page":
            {
                if (fs.existsSync(accountThemeSrcDirPath) &&
                    ...
                    console.warn(chalk.red(`There is already a ${pathRelative(process.cwd(), accountThemeSrcDirPath)} directory in your project. Aborting.`));
                    process.exit(-1);
                }
                ...
                fs.cpSync(pathJoin(getThisCodebaseRootDirPath(), "src", "bin", "initialize-account-theme", "multi-page-boilerplate"), accountThemeSrcDirPath, { recursive: true });
            }
            break;
        case "Single-Page":
            {
