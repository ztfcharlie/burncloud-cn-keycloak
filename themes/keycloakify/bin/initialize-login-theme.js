...
export async function command(params) {
    ...
    install_storybook: {
        ...
        for (let { relativeFilePath, fileContent } of files) {
            const filePath = pathJoin(buildContext.projectDirPath, ".storybook", relativeFilePath);
            {
    ...
    }
    {
        ...
        await fs.writeFile(buildContext.packageJsonFilePath, Buffer.from(sourceCode, "utf8"));
    }
    await npmInstall({
